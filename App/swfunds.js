...
export default class Swfunds extends Component {
    constructor(props){
        super(props);
    }
            ...
            <View style={StyleObject.UserFundReContainer}>
                ...
                <View style={StyleObject.UserFundReTop}>
                    <View style={StyleObject.UserFundReTopText}>
                        <Text style={{color:'#1d1d1d'}}>财富基金资金总额(元)</Text>
                        <View style={StyleObject.UserFundReTopNum}>
                            ...
                            <View style={[StyleObject.UserFundReStatus,StyleObject.UserFundStatus]}>
